    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="应用编码" prop="clientCode">
              <el-input v-model="form.clientCode" :disabled="form.id !== undefined" placeholder="请输入应用编码" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="授权方式" prop="authGrantTypes">
              <el-input v-model="form.authGrantTypes" placeholder="请输入授权方式(password,refresh_token,mobile,openId)" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
import { pageList, get, update, del, add } from '@/api/system/client'
export default {
  name: 'Client',
  data() {
    return {
